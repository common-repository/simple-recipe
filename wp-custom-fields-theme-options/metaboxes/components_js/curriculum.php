    ...
    Vue.component('stm-curriculum', {
        ...
        created: function () {
            ...
            if (this.stored_ids) {
                ...
                var url = stm_wpcfto_ajaxurl + '?action=stm_curriculum&nonce=' + stm_wpcfto_nonces['stm_curriculum'] + '&post_types=' + this.posts.join(',') + '&posts_per_page=-1&orderby=post__in&ids=' + this.stored_ids;
        ...
        methods: {
            ...
            createItem(item, model) {
                ...
                var url = stm_wpcfto_ajaxurl + '?action=stm_curriculum_create_item&nonce=' + stm_wpcfto_nonces['stm_curriculum_create_item'] + '&post_type=' + item + '&title=' + this[model];
                this.$http.get(url).then(function (response) {
